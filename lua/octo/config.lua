  ...
  return {
    ...
    mappings = {
      ...
      pull_request = {
        ...
        goto_issue = { lhs = "<localleader>gi", desc = "navigate to a local repo issue" },
        goto_link = { lhs = "<localleader>gl", desc = "open the linked issue or PR on this line" },
        commit_suggestion = { lhs = "<localleader>sc", desc = "commit the suggestion under the cursor" },
        dismiss_suggestion = { lhs = "<localleader>sd", desc = "turn down the suggestion under the cursor" },
        add_comment = { lhs = "<localleader>ca", desc = "add comment" },
        add_reply = { lhs = "<localleader>cr", desc = "add reply" },
        delete_comment = { lhs = "<localleader>cd", desc = "delete comment" },
        comment_edits = { lhs = "<localleader>ce", desc = "show comment edit history" },
